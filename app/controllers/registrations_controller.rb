...
class RegistrationsController < ApplicationController
  ...
  def create
    ...
    user =  MakeSchoolServer.post("https://www.makeschool.com/login.json", body: {'user[email]' => request.body[:email], 'user[password]' => request.body[:password]})
