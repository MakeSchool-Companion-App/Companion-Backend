...
class ControllersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create controller" do
    assert_difference('Controller.count') do
      post controllers_url, params: { controller: { Attendance: @controller.Attendance } }, as: :json
    end
  ...
  test "should update controller" do
    patch controller_url(@controller), params: { controller: { Attendance: @controller.Attendance } }, as: :json
    assert_response 200
  end
