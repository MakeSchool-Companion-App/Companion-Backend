...
RSpec.describe Attendance, type: :model do
  subject {
      User.new(id: 1, email: "matthewharrilal@gmail.com", password: "matthewharrilal", created_at: nil, updated_at: nil)
  }
  describe "Validations" do 
  #   it "must have in time and associated with user id" do
      
  #     attendance = Attendance.new(name: subject.email, in_time: "1:35pm", out_time:nil, created_at:nil, updated_at: nil, user_id: subject.id)
